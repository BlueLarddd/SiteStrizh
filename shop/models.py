...
class Product(models.Model):
    ...
    material = models.CharField(max_length=255, default='Неизвестно', blank=True, help_text="Введите материал товара")
    available = models.IntegerField(help_text='Введите доступное количество товара')
